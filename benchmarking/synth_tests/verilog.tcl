...
set project_name [file join $proj_dir $module_name]
...
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    ...
    # copy synthesis log
    set synth_log [file join $proj_dir $module_name.runs synth_1 runme.log]
...
if {[get_property PROGRESS [get_runs impl_1]] != "100%"} {
    ...
    set impl_log [file join $proj_dir $module_name.runs impl_1 runme.log]
