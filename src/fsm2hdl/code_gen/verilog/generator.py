"""
This module specifies the Verilog generator.
"""
...
from .state_parameters import prepare_state_parameter_pair
...
def generate_verilog(
    ...
    """
    Generates Verilog code for a given Fsm instance.
    ...
    # make sure HDL type in configuration is VERILOG
    cfg.hdl_type = HDLType.VERILOG
    ...
    template = env.get_template("fsm_top_verilog.j2")
    ...
    output = template.render(
        ...
        state_parameter_pair=prepare_state_parameter_pair(
    ...
    with open_file(directory_name, fsm.name, ".v", "w") as f:
        f.write(output)
        f.close()
